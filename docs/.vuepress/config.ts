  ...
  themeConfig: {
    nav: [
      ...
      },
      {
        text: 'NPM包',
        items: [
          { text: 'xy-commitlint-config', link: '/npm/commitlint.md' },
          { text: 'xy-stylelint-config', link: '/npm/stylelint.md' },
          { text: 'xy-markdownlint-config', link: '/npm/markdownlint.md' },
          { text: 'xy-eslint-config', link: '/npm/eslint.md' },
    ...
    sidebar: [
      ...
      },
      {
        title: 'NPM包',
        children: [
          { title: 'xy-commitlint-config', path: '/npm/commitlint.md' },
          { title: 'xy-stylelint-config', path: '/npm/stylelint.md' },
          { title: 'xy-markdownlint-config', path: '/npm/markdownlint.md' },
          { title: 'xy-eslint-config', path: '/npm/eslint.md' },
          { title: 'xy-eslint-plugin', path: '/npm/eslint-plugin.md' },
        ],
      },
    ],
    logo: '/img/logo.png',
    repo: 'GXY1523/fe-spec',
